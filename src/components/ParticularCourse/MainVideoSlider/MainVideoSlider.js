...
class MainVideoSlider extends Component {
	...
	timer() {
		...
		console.log(this.state.videos_playlist.length);
		console.log(this.state.video_item.video_index);
			if (!this.state.showModal) {
				if (Number(this.state.video_item.video_index) !== undefined) {
					if (Number(this.state.video_item.video_index) === this.state.videos_playlist.length) {
						this.setState({
